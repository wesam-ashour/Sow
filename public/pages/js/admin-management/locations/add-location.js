$(function () {
    ...
    function create_news() {
        ...
        var KTUsersAddPermission = function () {
            const t = document.getElementById("kt_modal_add_location"),
                ...
                init: function () {
                    (() => {
                        ...
                        i.addEventListener("click", (function (t) {
                            ...
                            $(".errors").html("");
                            var formData = new FormData(document.getElementById("kt_modal_add_location_form"));
                            ...
                            t.preventDefault(), o && o.validate().then((function (t) {
                                "Valid" == t ? $.ajax({
                                        ...
                                        type: "POST",
                                        url: app_url + "/" + language +"/locations",
                                        data: formData,

$(function () {
    ...
    function update_driver() {
        "use strict";
        var KTUsersAddPermission = function () {
            const t = document.getElementById("kt_modal_edit_driver"),
                e = t.querySelector("#kt_modal_update_drivers_form"),
                n = new bootstrap.Modal(t);
            return {
                init: function () {
                    (() => {
                        var o = FormValidation.formValidation(e, {
                            fields: {
                                edit_full_name: {validators: {notEmpty: {message: "Name is required"}}},
                                edit_email: {validators: {notEmpty: {message: "Email is required"}}},
                                edit_phone_number: {validators: {notEmpty: {message: "Phone Number is required"}}},
                                edit_address: {validators: {notEmpty: {message: "Address is required"}}},
                        ...
                        t.querySelector('[data-kt-editDriver-modal-action="close"]').addEventListener("click", (t => {
                            t.preventDefault(), Swal.fire({
                                text: language === "en" ? "Are you sure you would like to close?" : "هل أنت متأكد أنك تريد الإغلاق؟",
                                icon: "warning",
                                showCancelButton: !0,
                        ...
                        const i = t.querySelector('[data-kt-editDriver-modal-action="submit"]');
                        i.addEventListener("click", (function (t) {
                            $(':input[type="submit"]').prop('disabled', true);
                            $(".errors").html("");
                            ...
                            t.preventDefault(), o && o.validate().then((function (t) {
                                "Valid" == t ? $.ajax({
                                        ...
                                        type: "POST",
                                        url: app_url + "/" + language +"/drivers/update",
                                        data: formData,
                                        processData: false,  // tell jQuery not to process the data
                                        contentType: false,
                                        success: function (response) {
